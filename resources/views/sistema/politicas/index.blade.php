                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="alert alert-info mt-4">
                            ...
                            <strong>¿Cómo ejercer sus derechos?</strong> Para ejercer cualquiera de estos derechos, puede contactarnos a través de nuestro formulario de contacto o enviando un correo a <a href="mailto:privacidad@gijac.com">privacidad@gijac.com</a>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="mb-2">
                                                ...
                                                <strong>Email:</strong> privacidad@gijac.com
                                            </li>
                                            <li class="mb-2">
                                    ...
                                    <div class="col-md-6 d-none">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="mb-2">
                                                <i class="fas fa-envelope me-2 text-primary"></i>
                                                <strong>Email:</strong> dpo@gijac.com
                                            </li>
                                        </ul>
                                    </div>
                                </div>
